...
I used a conda environment to run the code. After activating a conda environment, make sure to install Scikit-learn, Tensorflow, Keras, and Jupyter with Python version 3.x.
