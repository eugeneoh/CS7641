    ...
    envs = [
        {
            ...
            'name': 'frozen_lake_no_reward_goal_4',
            'readable_name': 'Frozen Lake No Reward Goal 4 (8x8)',
        },
        {
            # This is not really a rewarding frozen lake env, but the custom class has extra functionality
            'env': environments.get_rewarding_frozen_lake_environment(),
            'name': 'frozen_lake_reward_goal_4',
            'readable_name': 'Frozen Lake Reward Goal 4 (8x8)',
        },
        # {
